 ...
 ************************************/
 ...
 /*@bgen(jjtree) Statement */
  ...
  static final public void Expression(SymbId scope) throws ParseException {
 /*@bgen(jjtree) Expression */
  ...
  static final public void MessageSend(SymbId scope) throws ParseException {
    PrimaryExpression(scope);
    jj_consume_token(DOT);
    Identifier();
    jj_consume_token(LPAREN);
  ...
  static final public void ExpressionList(SymbId scope) throws ParseException {
    Expression(scope);
    label_10:
    while (true) {
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      ...
      ExpressionRest(scope);
    }
  }

  static final public void ExpressionRest(SymbId scope) throws ParseException {
    jj_consume_token(47);
    Expression(scope);
  }

  static final public String PrimaryExpression(SymbId scope) throws ParseException {
        String ret;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case INTEGER_LITERAL:
      IntegerLiteral();
    ...
    default:
      jj_la1[16] = jj_gen;
      if (jj_2_14(3)) {
        ArrayAllocationExpression(scope);
      } else {
        switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
        case NEW:
          AllocationExpression(scope);
          break;
        case NOT:
          NotExpression(scope);
          break;
        case LPAREN:
          BracketExpression(scope);
          break;
        default:
          jj_la1[17] = jj_gen;
          jj_consume_token(-1);
  ...
  static final public void ThisExpression(SymbId path) throws ParseException {
    jj_consume_token(THIS);
  }

  static final public void ArrayAllocationExpression(SymbId path) throws ParseException {
  ...
  static final public void AllocationExpression(SymbId path) throws ParseException {
    jj_consume_token(NEW);
    Identifier();
    jj_consume_token(LPAREN);
    jj_consume_token(RPAREN);
  ...
  static final public void BracketExpression(SymbId path) throws ParseException {
    jj_consume_token(LPAREN);
    Expression(path);
    jj_consume_token(RPAREN);
  }
