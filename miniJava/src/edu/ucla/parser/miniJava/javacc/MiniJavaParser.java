...
public class MiniJavaParser/*@bgen(jjtree)*/implements MiniJavaParserTreeConstants, MiniJavaParserConstants {/*@bgen(jjtree)*/
  protected static JJTMiniJavaParserState jjtree = new JJTMiniJavaParserState();public Node getRoot( )
        {
 ...
 ************************************/
 ...
 /*@bgen(jjtree) ClassExtendsDeclaration */
  ...
  static final public Variable VarDeclaration(SymbId path) throws ParseException {
 /*@bgen(jjtree) VarDeclaration */
  ...
  static final public Function MethodDeclaration(SymbId path) throws ParseException {
 /*@bgen(jjtree) MethodDeclaration */
  ...
  Variable ret;
    ...
    pos=jjtn000.pos(jj_input_stream);
      ...
      t = Identifier();
                ...
                if( jjtn000._call_graph._all_nodes.get(t.image)==null ) jjtn000._call_graph._all_nodes.put( t.image, new GraphNode(t.image) );
      jj_consume_token(LPAREN);
      switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
      case BOOLEAN:
      case INTEGER:
     ...
     jjtc000 = false;
                func._return=ret;
                if( ret!=null ) jjtn000._return.add( new TwoSymbols(func,ret) );
                {if (true) return func;}
    } catch (Throwable jjte000) {
    if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
  ...
  static final public Vector<Variable> FormalParameterList(SymbId path) throws ParseException {
  ...
  static final public Variable FormalParameter(SymbId path) throws ParseException {
 /*@bgen(jjtree) FormalParameter */
  ...
  static final public Variable FormalParameterRest(SymbId path) throws ParseException {
  Variable symb;
    jj_consume_token(47);
 ...
 /*@bgen(jjtree) AssignmentStatement */
    ...
    jjtc000 = false;
                ...
                if( right instanceof Heap )
                        jjtn000._vP0.add( new TwoSymbols(left,right) );
                else
                        jjtn000._assign.add( new TwoSymbols(left,right) );
    } catch (Throwable jjte000) {
    if (jjtc000) {
      jjtree.clearNodeScope(jjtn000);
      jjtc000 = false;
 ...
 /*@bgen(jjtree) Statement */
  ...
  static final public Variable Expression(SymbId scope) throws ParseException {
 /*@bgen(jjtree) Expression */
        ASTExpression jjtn000 = new ASTExpression(JJTEXPRESSION);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);Variable ret=null;
    try {
  ...
  static final public Variable MessageSend(SymbId scope) throws ParseException {
 /*@bgen(jjtree) MessageSend */
        ASTMessageSend jjtn000 = new ASTMessageSend(JJTMESSAGESEND);
        boolean jjtc000 = true;
        jjtree.openNodeScope(jjtn000);Variable var;
        Token t;
    ...
    jjtc000 = false;
                ...
                jjtn000._mI.add( new mI(invocation_method,call,t.image) );
                jjtn000._callreturn.add( new TwoSymbols(call,ret) );
  ...
  static final public Vector<Variable> ExpressionList(SymbId scope) throws ParseException {
        Vector<Variable> list=new Vector<Variable>();
        Variable var;
  ...
  static final public Variable ExpressionRest(SymbId scope) throws ParseException {
        Variable var;
    jj_consume_token(47);
    var = Expression(scope);
          {if (true) return var;}
  ...
  static final public Variable PrimaryExpression(SymbId scope) throws ParseException {
 /*@bgen(jjtree) PrimaryExpression */
  ...
  static final public Variable ThisExpression(SymbId path) throws ParseException {
 /*@bgen(jjtree) ThisExpression */
  ...
  static final public Variable ArrayAllocationExpression(SymbId path) throws ParseException {
 /*@bgen(jjtree) ArrayAllocationExpression */
  ...
  static final public Variable AllocationExpression(SymbId path) throws ParseException {
 /*@bgen(jjtree) AllocationExpression */
  ...
  static final public Variable BracketExpression(SymbId path) throws ParseException {
        Variable ret;
    jj_consume_token(LPAREN);
    ret = Expression(path);
    jj_consume_token(RPAREN);
